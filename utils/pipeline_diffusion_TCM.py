class NetMeasure:
    ...
    def __init__(self, G, seed_ids, drugs_to_targets):

        net_nodes = set(G.nodes())
        drugs_list = list(drugs_to_targets.keys())
        ...
        self.app_drugs = []  # Remove app_drugs attribute
    ...
    def make_df(self):
        ...
        # Remove the part related to app_drugs_to_targets
        df_final = df[['Drug', 'Degree', 'Targets'] + [m + '-Rank' for m in models] + [m for m in models]]
