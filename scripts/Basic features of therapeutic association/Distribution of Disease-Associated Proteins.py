...
# ------------------------------------------------------------
# 1. Locate project root directory (scripts/ -> mmi/)
# ------------------------------------------------------------
...
# ------------------------------------------------------------
counts_dir = os.path.join(project_root, "output", "Number of disease-associated proteins")
file1 = os.path.join(counts_dir, "Drug_disease_protein_in_graph_counts.csv")
file2 = os.path.join(counts_dir, "CTD_disease_protein_in_graph_counts.csv")
file3 = os.path.join(counts_dir, "TCM_symptom_protein_in_graph_counts.csv")
...
ax.set_title("Distribution of disease-associated protein numbers")
...
ax.set_ylabel("Number of disease-associated proteins")
...
plt.tight_layout()
# Output path matched to your project
out_path = os.path.join(project_root, "output", "graph", "disease_protein_number_distribution.png")
...
print(f"DD vs CD: U={u12:.4f}, p={p12:.4e} {sig_label(p12)}")
print(f"DD vs HS: U={u13:.4f}, p={p13:.4e} {sig_label(p13)}")
print(f"CD vs HS: U={u23:.4f}, p={p23:.4e} {sig_label(p23)}")
print("\nKolmogorov–Smirnov Test Results:")
print(f"DD vs CD: D={ks12:.4f}, p={pks12:.4e} {sig_label(pks12)}")
print(f"DD vs HS: D={ks13:.4f}, p={pks13:.4e} {sig_label(pks13)}")
print(f"CD vs HS: D={ks23:.4f}, p={pks23:.4e} {sig_label(pks23)}")