...
def HeterogeneousSG(use_hetSG:bool, walks:list, nodes:set, nodetypef:str, embedding_size:int, 
    ...
    if not os.path.exists('Random_Walk/HeterogeneousSG.cpp'):
    ...
    os.system('g++ Random_Walk/HeterogeneousSG.cpp -o HetSG.exe -lm -pthread -O1 -march=native -Wall -funroll-loops -Wno-unused-result')
