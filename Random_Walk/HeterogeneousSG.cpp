...
//  unsigned long long next_random = 43 + (intptr_t)id; //新增
  long long thread_id = (long long)(intptr_t)id;                 // 还原线程编号
  unsigned long long next_random = 43ULL + (unsigned long long)thread_id;  // 每个线程不同 seed
...
//  for (a = 0; a < num_threads; a++) pthread_create(&pt[a], NULL, TrainModelThread, (void *)a);
  for (a = 0; a < num_threads; a++) pthread_create(&pt[a], NULL, TrainModelThread, (void*)(intptr_t)a); // 修改
